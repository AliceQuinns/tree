...
const _URL = {
    ...
    btnsize: {width:80,height:100},// 按钮尺寸
...
export default class index{
    ...
    render(){
        ...
        this.ctx.drawImage(this.play,screenWidth/2-_URL.playsize.width/2,screenHeight/1.5,_URL.playsize.width,_URL.playsize.height);
        this.ctx.drawImage(this.rankList,_URL.btnsize.width/2,screenHeight/1.2,_URL.btnsize.width,_URL.btnsize.height);
        this.ctx.drawImage(this.share,screenWidth/2-_URL.btnsize.width/2,screenHeight/1.2,_URL.btnsize.width,_URL.btnsize.height);
        this.ctx.drawImage(this.game,screenWidth-_URL.btnsize.width*1.5,screenHeight/1.2,_URL.btnsize.width,_URL.btnsize.height);
        // 坐标矩阵
        this.playRange = {
        ...
        this.rankListRange = {
            ...
            endY  : screenHeight/1.2 + _URL.btnsize.height
        };
        this.shareRange = {
